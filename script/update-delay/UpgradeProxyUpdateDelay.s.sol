...
contract UpgradeProxyUpdateDelay is UpgradeProxyUpdateDelayBase {
    ...
    // Delay for upgradeProxy operations
    ...
    /**
     * @notice Schedule a upgradeProxyUpdateDelay through the timelock
     */
    ...
    /**
     * @notice Execute a upgradeProxyUpdateDelay immediately through the timelock
     */
    ...
    /**
     * @notice Schedule and execute a upgradeProxyUpdateDelay through the timelock
